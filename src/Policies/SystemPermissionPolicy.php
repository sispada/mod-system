...
class SystemPermissionPolicy
{
     ...
     */
    public function show(SystemUser $user, SystemPermission $systemPermission): bool
    {
     ...
     */
    public function update(SystemUser $user, SystemPermission $systemPermission): bool
    {
     ...
     */
    public function delete(SystemUser $user, SystemPermission $systemPermission): bool
    {
     ...
     */
    public function restore(SystemUser $user, SystemPermission $systemPermission): bool
    {
     ...
     */
    public function destroy(SystemUser $user, SystemPermission $systemPermission): bool
    {
