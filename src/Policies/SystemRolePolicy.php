...
class SystemRolePolicy
{
     ...
     */
    public function show(SystemUser $user, SystemRole $systemRole): bool
    {
     ...
     */
    public function update(SystemUser $user, SystemRole $systemRole): bool
    {
     ...
     */
    public function delete(SystemUser $user, SystemRole $systemRole): bool
    {
     ...
     */
    public function restore(SystemUser $user, SystemRole $systemRole): bool
    {
     ...
     */
    public function destroy(SystemUser $user, SystemRole $systemRole): bool
    {
